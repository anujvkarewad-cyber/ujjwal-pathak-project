...
function ScenarioBlock({ scenarioId }) {
  ...
  const decide = (decision) => {
    decideScenario.mutate(
      { id: scenarioId, decision, comment, warningsAcknowledged: false, attemptSpecificRiskConfirmed: false },
      {
...
export default function ScenarioReview() {
  const { data, isLoading } = useReviewQueue({ questionType: 'scenario_mcq', limit: 500 });
